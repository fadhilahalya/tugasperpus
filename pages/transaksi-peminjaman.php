<div id="label-page"><h2>Data Transaksi</h2></div>
<div id="content">
	
	<p id="tombol-tambah-container"><a href="index.php?p=transaksi-peminjaman-input" class="tombol">Tambah Data Transaksi</a>
	<a target="_blank" href="pages/cetak-peminjaman.php"><img src="print.png" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		<tr>
			...
			<td>
				<div class="tombol-opsi-container"><a target="_blank" href="pages/cetak_peminjaman.php?id=<?php echo $r_tampil_transaksi['idanggota'];?>" class="tombol">Cetak Transaksi</a></div>

				<div class="tombol-opsi-container"><a href="index.php?p=transaksi-edit&id=<?php echo $r_tampil_transaksi['idanggota'];?>" class="tombol">Edit</a></div>

				<div class="tombol-opsi-container"><a href="proses/transaksi-hapus.php?id=<?php echo $r_tampil_transaksi['idanggota']; ?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol">Hapus</a></div>
			</td>			
		</tr>		
		<?php $nomor++; } 
		}
